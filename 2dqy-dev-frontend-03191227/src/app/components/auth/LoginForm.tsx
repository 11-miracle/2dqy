            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
                ...
                <div className="flex flex-col space-y-4">
                    <button
                        ...
                        className="bg-gray-800 text-white py-2 rounded-full flex items-center justify-center space-x-2 hover:bg-gray-700 transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="bg-blue-500 text-white py-2 rounded-full flex items-center justify-center space-x-2 hover:bg-blue-600 transition-colors"
                    >
